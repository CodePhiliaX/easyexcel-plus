...
import ai.chat2db.excel.test.core.head.ComplexHeadData;
...
import ai.chat2db.excel.write.style.column.LongestMatchColumnWidthStyleStrategy;
...
import ai.chat2db.excel.metadata.data.HyperlinkData.HyperlinkType;
...
public class WriteTest {
    ...
    public void complexHeadWrite() {
        ...
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
        EasyExcel.write(fileName, ai.chat2db.excel.test.core.head.ComplexHeadData.class).sheet("模板").doWrite(data());
    }
